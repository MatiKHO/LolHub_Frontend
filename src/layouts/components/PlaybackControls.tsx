    ...
    <footer className="h-20 sm:h-24 bg-gradient-to-t from-black via-purple-950/20 to-purple-950/20 border-t border-zinc-800 px-4 mx-2 rounded-lg">
      <div className="flex justify-between items-center h-full max-w-[1800px] mx-auto">
        ...
        <div className="flex flex-col items-center gap-2 flex-1 max-w-full sm:max-w-[45%]">
          <div className="flex items-center gap-4 sm:gap-6">
            <Button
              size="icon"
              variant="ghost"
              className="hidden sm:inline-flex hover:text-purple-500 text-zinc-400"
            >
            ...
            <Button
              size="icon"
              variant="ghost"
              className="hover:text-purple-500 text-zinc-400"
        ...
        <div className="hidden sm:flex items-center gap-4 min-w-[180px] w-[30%] justify-end">
            <Button size="icon" variant="ghost" className="text-zinc-400 hover:text-purple-500">
