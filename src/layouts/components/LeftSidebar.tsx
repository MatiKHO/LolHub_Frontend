...
export const LeftSidebar = () => {
  ...
  return (
    <div className="h-full flex flex-col gap-2">
      ...
      {/* Library section */}
      <div className="flex-1 rounded-lg bg-gradient-to-b from-zinc-800 via-zinc-900 to-purple-950/20 p-4">
            ...
            {isLoading ? (
              ...
              albums.map((album) => (
                <Link
                  to={`/albums/${album._id}`}
                  key={album._id}
                  className="p-2 hover:bg-zinc-800 hover:scale-102 transition-all ease-in-out duration-200 rounded-md flex items-center gap-3 group cursor-pointer"
                >
                  <img
                    src={album.imageUrl}
                    alt="Playlist"
