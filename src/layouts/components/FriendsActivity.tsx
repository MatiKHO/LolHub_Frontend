...
export const FriendsActivity = () => {
	...
	return (
		<div className='h-full bg-gradient-to-b from-zinc-800 via-zinc-900 to-purple-950/20 rounded-lg flex flex-col'>
...
const LoginPrompt = () => (
	<div className='h-full flex flex-col items-center justify-center p-6 text-center space-y-4'>
		<div className='relative'>
			<div
				className='absolute -inset-1 bg-gradient-to-br from-purple-500 to-purple-950/20 rounded-full blur-lg
